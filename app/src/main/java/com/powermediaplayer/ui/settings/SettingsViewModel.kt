...
class SettingsViewModel @Inject constructor(
    ...
    fun clearHueSelectedArea() {
        viewModelScope.launch {
            ...
            // re-pick dead (the collector gated on intensity=0 forever)
            // and silently reset a user preference whose slider lives in
            // the collapsed Tuning sub-section. The stream still stops on
            // disconnect: the collector treats a blank area as off.
            settingsDataStore.setHueSelectedArea("")
        }
    }
